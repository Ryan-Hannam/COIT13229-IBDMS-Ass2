...
public class Drone extends Thread {
    ...
    static ArrayList<Domain.FireDetails> fires = new ArrayList<>(); // ArrayList for storing fires found since last server update
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        drone = new Domain.DroneDetails(id, name, x_pos, y_pos, true);
    ...
    public void run() {
        ...
        while (true) {
            ...
            if (numFires > 0) {
                for (Domain.FireDetails p : Drone.fires) {
                    out.writeObject(p);
                    serverMessage = (String)in.readObject();
                }
